import{F as Me,s as we,U as N,M as g,G as Se,c as Pe,S as Ge,t as Re,u as Be,E as u,v as _,x as Ue,y as z,z as q,H as K,I as Ae,q as m,i as p,m as B,w as Y,J as H,K as Ie,j as L,B as k,n as U,L as M,o as b,N as w,O as De,b as Ee,C as S,Q as Fe,V as Oe,W as ze,X as J,e as X,Y as He,P as Le,k as We,R as Q,D as Z,Z as Ve,_ as je,$ as $e}from"./index-DMw71Hwe.js";import{B as Ne,d as qe}from"./colorToUniform-arTk96QK.js";var Ke=`in vec2 vMaskCoord;
...
}`;class Je extends Me{constructor(e){const{sprite:t,...r}=e,n=new we(t.texture),a=new N({uFilterMatrix:{value:new g,type:"mat3x3<f32>"},uMaskClamp:{value:n.uClampFrame,type:"vec4<f32>"},uAlpha:{value:1,type:"f32"}}),i=Se.from({vertex:{source:W,entryPoint:"mainVertex"},fragment:{source:W,entryPoint:"mainFragment"}}),l=Pe.from({vertex:Ye,fragment:Ke,name:"mask-filter"});super({...r,gpuProgram:i,glProgram:l,resources:{filterUniforms:a,uMaskTexture:t.texture.source}}),this.sprite=t,this._textureMatrix=n}apply(e,t,r,n){this._textureMatrix.texture=this.sprite.texture,e.calculateSpriteMatrix(this.resources.filterUniforms.uniforms.uFilterMatrix,this.sprite).prepend(this._textureMatrix.mapCoord),this.resources.uMaskTexture=this.sprite.texture.source,e.applyFilter(this,t,r,n)}}class ee{constructor(e,t){this.state=Ge.for2d(),this._batches=Object.create(null),this._geometries=Object.create(null),this.renderer=e,this._adaptor=t,this._adaptor.init(this)}buildStart(e){if(!this._batches[e.uid]){const t=new Re;this._batches[e.uid]=t,this._geometries[t.uid]=new Be}this._activeBatch=this._batches[e.uid],this._activeGeometry=this._geometries[this._activeBatch.uid],this._activeBatch.begin()}addToBatch(e){this._activeBatch.add(e)}break(e){this._activeBatch.break(e)}buildEnd(e){const t=this._activeBatch,r=this._activeGeometry;t.finish(e),r.indexBuffer.setDataWithSize(t.indexBuffer,t.indexSize,!0),r.buffers[0].setDataWithSize(t.attributeBuffer.float32View,t.attributeSize,!1)}upload(e){const t=this._batches[e.uid],r=this._geometries[t.uid];t.dirty&&(t.dirty=!1,r.buffers[0].update(t.attributeSize*4))}execute(e){if(e.action==="startBatch"){const t=e.batcher,r=this._geometries[t.uid];this._adaptor.start(this,r)}this._adaptor.execute(this,e)}destroy(){this.state=null,this.renderer=null,this._adaptor.destroy(),this._adaptor=null;for(const e in this._batches)this._batches[e].destroy();this._batches=null;for(const e in this._geometries)this._geometries[e].destroy();this._geometries=null}}ee.extension={type:[u.WebGLPipes,u.WebGPUPipes,u.CanvasPipes],name:"batch"};const Tt={name:"texture-bit",vertex:{header:`

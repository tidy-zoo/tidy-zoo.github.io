  ...
  async initialize() {
    ...
    Assets.load(
      [
        ...
        { alias: 'igBtn', src: '/assets/promote/igBtn.png' },
        { alias: 'lineBtn', src: '/assets/promote/lineBtn.png' },
        { alias: 'fbBtn', src: '/assets/promote/fbBtn.png' },
        { alias: 'zeczecBtn', src: '/assets/promote/zeczecBtn.png' },
        ...
        { alias: 'promoteFb', src: '/assets/promote/fb.png' },
